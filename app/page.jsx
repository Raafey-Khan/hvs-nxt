    ...
    <div className="header-text-testimonials">
      ...
      <div className="flex-containerr flex  justify-center items-center gap-8 mb-9">
        ...
        <div className="h-full w-full">
          <div className=" bg-[url('../public/images/Testimonial-img-2.png')] bg-cover h-[470px] bg-center bg-no-repeat flex justify-center items-center">
          <img src="images/Testimonial-play-solid-btn.png" alt="" />
          </div>
        
        </div>

        <div>
          <img className="w-[5rem]" src="images/circle-arrow-up-right.png" alt="" />
        </div>
      </div>
